...
public:		
	...
	virtual bool createWindow(const char* title, unsigned width, unsigned height, unsigned char bits = 32);
	...
	virtual void drawQuad(const Vector3f *vertexs, const Vector3f& n, const Color4f &colors) const;
